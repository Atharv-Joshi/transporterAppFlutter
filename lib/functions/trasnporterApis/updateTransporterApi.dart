...
Future<String> updateTransporterApi({required bool accountVerificationInProgress,required String transporterId})async{
  ...
  final response = await http.put(Uri.parse("$transporterApiUrl/$transporterId"),
  ...
  if (response.statusCode == 200) {
    ...
    bool transporterApproved = decodedResponse["transporterApproved"].toString() == "true";
    ...
    String mobileNum = decodedResponse["phoneNo"] != null? decodedResponse["phoneNo"].toString() : "";
    ...
    transporterIdController.updateAccountVerificationInProgress(accountVerificationInProgress);
