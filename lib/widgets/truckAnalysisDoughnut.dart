...
class _truckAnalysisDoughnutState extends State<truckAnalysisDoughnut> {
  ...
  List<analysisData> getChartData() {
    final List<analysisData> chartData = [
      ...
      analysisData('unloading', analysisDataController.unLoadingPointData.value, Color.fromRGBO(192, 108, 132, 1)),
      analysisData('parking', analysisDataController.parkingData.value, Color.fromRGBO(255, 105, 180, 1)),
      analysisData('maintenance', analysisDataController.maintenanceData.value, Color.fromRGBO(246, 211, 198, 1)),
      analysisData('running', analysisDataController.runningTimeData.value, Color.fromRGBO(0, 204, 0, 1)),
      analysisData('stop', analysisDataController.unknownStopData.value, Color.fromRGBO(230, 0, 0, 1))
    ];
    return chartData;
  }
