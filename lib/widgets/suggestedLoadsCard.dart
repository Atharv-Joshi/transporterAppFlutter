  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          ...
          widget.loadDetailsScreenModel.loadPosterId =
              snapshot.data.loadPosterId;
          widget.loadDetailsScreenModel.phoneNo =
              snapshot.data.loadPosterPhoneNo;
          widget.loadDetailsScreenModel.loadPosterLocation =
              snapshot.data.loadPosterLocation;
          widget.loadDetailsScreenModel.loadPosterName =
              snapshot.data.loadPosterName;
          widget.loadDetailsScreenModel.loadPosterCompanyName =
              snapshot.data.loadPosterCompanyName;
          widget.loadDetailsScreenModel.loadPosterKyc =
              snapshot.data.loadPosterKyc;
          widget.loadDetailsScreenModel.loadPosterCompanyApproved =
              snapshot.data.loadPosterCompanyApproved;
          widget.loadDetailsScreenModel.loadPosterApproved =
              snapshot.data.loadPosterApproved;
              ...
              children: [
                ...
                LoadCardFooter(
                  loadPosterCompanyName: widget
                      ...
                      .toString(),
                  loadPosterPhoneNo:
                      widget.loadDetailsScreenModel.phoneNo.toString(),
                )
              ],
            ),
          ),
