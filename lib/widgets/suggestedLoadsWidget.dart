...
class SuggestedLoadsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        //TODO: Constructor Call onpress of See all is above the runSuggestedLoadAPI() Henceforth temporarily whole code has been put in FutureBuilder
        child: FutureBuilder(
                        ...
                        child: Row(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                  ...
                                  child: Text("See All",
                                      style:
                                          TextStyle(color: liveasyGreenColor)))
                            ]),
                      )),
                  Container(
                      height: 106,
