...
import 'package:liveasy/widgets/FastagDesktop.dart';
import 'package:liveasy/widgets/FastagMobile.dart';
                ...
                children: [
                  Text(widget.loadingPoint ?? '',
                      style: GoogleFonts.montserrat(
                          fontWeight: FontWeight.w500, color: tryAgainButton)),
                ],
              ),
            ),
              ...
              child: Column(
                ...
                children: [
                  Text(widget.unloadingPoint ?? '',
                      style: GoogleFonts.montserrat(
                          fontWeight: FontWeight.w500, color: liveasyGreen)),
                ],
              ),
            ),
