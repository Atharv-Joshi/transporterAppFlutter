...
//       camPosition = CameraPosition(target: lastlatLngMarker, zoom: 11);
...
//     end = LatLng(widget.gpsData.last.lat, widget.gpsData.last.lng);
//     setState(() {
...
//   _getPolyline(LatLng start, LatLng end) async {
//     double _originLatitude = 26.48424, _originLongitude = 50.04551;
//     double _destLatitude = 26.46423, _destLongitude = 50.06358;
//     var thisone = LatLng(_originLatitude, _originLongitude);
//     var thistwo = LatLng(_destLatitude, _destLongitude);
...
//       LatLng latLngMarker = LatLng(newGPSData.last.lat, newGPSData.last.lng);
